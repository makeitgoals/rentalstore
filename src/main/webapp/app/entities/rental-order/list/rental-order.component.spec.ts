...
describe('Component Tests', () => {
  describe('RentalOrder Management Component', () => {
    let comp: RentalOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RentalOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rentalOrders[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
